 ...
 * `prisma.user`: Exposes CRUD operations for the **User** model.
  ...
  */
    ...
    /**
     * `prisma.plannerBlock`: Exposes CRUD operations for the **PlannerBlock** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more PlannerBlocks
      * const plannerBlocks = await prisma.plannerBlock.findMany()
      * ```
      */
    get plannerBlock(): Prisma.PlannerBlockDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
